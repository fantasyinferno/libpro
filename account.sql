...
create table account(account_id INTEGER PRIMARY KEY, account VARCHAR(255), password TEXT, status_id INTEGER, fullname VARCHAR(255), identity_number VARCHAR(12), gender_id INTEGER, birthdate DATE, email VARCHAR(255), job VARCHAR(50), avatar BLOB, UNIQUE (account));
